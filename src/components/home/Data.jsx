...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Ahmed Gamal
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Front-end Web development</h3>
        <p className='home__description'>I'm creative web designer based in Cairo, and I'm very passionate and 
